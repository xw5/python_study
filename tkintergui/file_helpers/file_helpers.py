...
class  file_helpers:
    def __init__(self,root,isTKroot = True):
        ...
        Fun.SetControlPlace(uiName,'Label_6',14,116,82,30)
        ...
        Fun.SetControlPlace(uiName,'Entry_7',99,116,164,30)
