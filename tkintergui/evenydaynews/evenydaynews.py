...
class  evenydaynews:
    def __init__(self,root,isTKroot = True):
        ...
        Fun.SetControlPlace(uiName,'ComboBox_5',104,37,167,30)
        ...
        Fun.SetControlPlace(uiName,'Text_7',17,109,434,407)
        Text_7.configure(relief = "sunken")
        Text_7_Scrollbar = tkinter.Scrollbar(Text_7,orient=tkinter.VERTICAL)
        Text_7_Scrollbar.place(x = 414,y = 0,width = 20,height = 407)
        ...
        Fun.SetControlPlace(uiName,'Text_10',470,219,209,372)
        Text_10.configure(relief = "sunken")
        Text_10_Scrollbar = tkinter.Scrollbar(Text_10,orient=tkinter.VERTICAL)
        Text_10_Scrollbar.place(x = 189,y = 0,width = 20,height = 372)
        ...
        Fun.SetControlPlace(uiName,'ComboBox_14',470,109,125,30)
        ...
        Fun.SetControlPlace(uiName,'Text_16',470,148,209,61)
        Text_16.configure(relief = "sunken")
        Text_16_Scrollbar = tkinter.Scrollbar(Text_16,orient=tkinter.VERTICAL)
        Text_16_Scrollbar.place(x = 189,y = 0,width = 20,height = 61)
