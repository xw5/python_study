...
class  evenydaynews:
    def __init__(self,root,isTKroot = True):
        ...
        Fun.SetControlPlace(uiName,'Text_10',434,116,245,352)
        Text_10.configure(relief = "sunken")
        Text_10_Scrollbar = tkinter.Scrollbar(Text_10,orient=tkinter.VERTICAL)
        Text_10_Scrollbar.place(x = 225,y = 0,width = 20,height = 352)
        ...
        Fun.SetControlPlace(uiName,'Label_9',434,76,70,29)
